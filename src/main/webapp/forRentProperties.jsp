...
<html>
<head>
    <title>RS Properties - For Rent Properties</title>
...
<c:forEach items="${forRentProperties}" var="property">
    <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
            <a href="viewDetails?id=${property.id}" class="card-link"><button type="button" class="btn btn-secondary btn-lg">View Details</button></a>
        </div>
    </div>
</c:forEach>

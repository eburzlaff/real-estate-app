...
@WebServlet(name = "RemovePropertyView", urlPatterns = { "/removePropertyView" } )
public class RemovePropertyView extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("removePropertyView" +
                ".jsp");
